...
# system time zone.
TIME_ZONE = "America/Mexico_City"               # MX
...
USE_TZ = False                  # Modified 20170807: Use Naive DateTimes
...
SECRET_KEY = "elfoi_f09u4u2rka5gz960qv6zon5*%u)y(gl3do--w_t4ek1)"
...
ROOT_URLCONF = "scazac.urls"

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = "scazac.wsgi.application"
